...
mnist_autoencoder_fpath = os.path.join(project_path, "externals/MagNet/defensive_models/MNIST_I")
cifar10_autoencoder_fpath = os.path.join(project_path, "externals/MagNet/defensive_models/CIFAR")
