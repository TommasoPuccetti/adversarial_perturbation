...
class ClassifierWrapper:
    def __init__(self, model, in_shape=448):
        """
        ...
        self.softmax.add(Lambda(lambda X: softmax(X, axis=1), input_shape=(in_shape,)))
...
class MagNetDetector:
    def __init__(self, model, detector_name, input_shape=448):
        classifier = ClassifierWrapper(model, input_shape)
