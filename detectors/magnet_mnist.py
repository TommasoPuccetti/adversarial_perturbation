...
class MagNetDetector:
    def __init__(self, model, detector_name):
        ...
        autoencoder_model_I_fpath = os.path.join("./externals/MagNet/defensive_models/MNIST_I")
        autoencoder_model_II_fpath = os.path.join("./externals/MagNet/defensive_models/MNIST_II")
